 ...
 */
public class FlashBuilderMojo extends FlexBuilderMojo {

	/**
	 * IDE Verion. First release of Flashbuilder is version 10.
	 * 
	...
	protected VelocityContext getAsPropertiesContext(ProjectType type, Collection<FbIdeDependency> dependencies)
		...
		context.put("projectUUID", UUID.randomUUID().toString());
		return context;
	}
	 ...
	 * dependencies. For example: 4.0.0 will import into Flexbuilder as
	 * "Flex 4.0" 3.5.0 will import as Flex "3.5". This override differs from
	 * the base function in that versions such as 4.0.0 will return 4.0 instead
	 * of 4 as in the base implementation.
	 * 
	 * @return
	 */
	@Override
